...
Shader "ASE/Shui/DingDianPianYi"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_Color0("基础色", Color) = (1,1,1,1)
		_Color1("高光色", Color) = (0,0,0,0)
		_Float0("光滑", Range( 0 , 1)) = 0
		_Float4("Float 4", Float) = 1
		_Float3("Float 3", Float) = 1
		_Float1("x", Float) = 1
		_Float2("y", Float) = 1
		_Float5("z", Float) = 0
		[HDR]_Color2("自发光", Color) = (0,0,0,0)
		_TextureSample0("自发光贴图", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime27 = _TimeParameters.x * _Float3;
				float2 uv_TextureSample0 = v.texcoord.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 tex2DNode35 = tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) );
				float3 temp_cast_0 = (( sin( ( ( ( _Float1 * v.positionOS.xyz.x ) + ( v.positionOS.xyz.y * _Float2 ) + ( v.positionOS.xyz.z * _Float5 ) ) + mulTime27 ) ) * tex2DNode35.r * _Float4 )).xxx;
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = ( _Color2 * tex2DNode35 ).rgb;
				float3 Specular = _Color1.rgb;
				float Metallic = 0;
				float Smoothness = _Float0;
				float Occlusion = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime27 = _TimeParameters.x * _Float3;
				float2 uv_TextureSample0 = v.texcoord0.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 tex2DNode35 = tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) );
				float3 temp_cast_0 = (( sin( ( ( ( _Float1 * v.positionOS.xyz.x ) + ( v.positionOS.xyz.y * _Float2 ) + ( v.positionOS.xyz.z * _Float5 ) ) + mulTime27 ) ) * tex2DNode35.r * _Float4 )).xxx;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.PosVertexDataNode;19;-760.5,343.5;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-596.5,290.5;Inherit;False;Property;_Float1;x;5;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-598.5,489.5;Inherit;False;Property;_Float2;y;6;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-599.6045,593.0243;Inherit;False;Property;_Float5;z;7;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-409.5,344.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-410.5,440.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-504.5,759.5;Inherit;False;Property;_Float3;Float 3;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-403.6045,550.0243;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;24;-206.5,350.5;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;27;-287.5,728.5;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;25;-59.5,444.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;29;82.5,445.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;86.16454,707.7283;Inherit;False;Property;_Float4;Float 4;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;35;-56.94434,155.8275;Inherit;True;Property;_TextureSample0;自发光贴图;9;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-565.5,-184.5;Inherit;False;Property;_Color0;基础色;0;0;Create;False;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-596.5,179.5;Inherit;False;Property;_Float0;光滑;2;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-533.5,7.5;Inherit;False;Property;_Color1;高光色;1;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;286.3001,520.7004;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;271.0557,-26.17245;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;33;-40.94434,-119.1725;Inherit;False;Property;_Color2;自发光;8;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=39CAEA6C6B2245E22EC699D78EEBF144BAAE1DCA