...
Shader "ASE/DingDianPianYi"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[NoScaleOffset]_TextureSample0("基础色", 2D) = "white" {}
		_Color0("颜色", Color) = (0.5490196,0.5411765,0.5411765,1)
		_Float3("剪切", Range( 0 , 1)) = 1
		[NoScaleOffset]_TextureSample1("遮罩", 2D) = "white" {}
		_Float0("金属", Range( 0 , 1)) = 1
		_Float1("粗糙", Range( 0 , 1)) = 0.5
		[NoScaleOffset]_TextureSample2("法线", 2D) = "bump" {}
		_Float2("发现强度", Range( 0 , 1)) = 1
		[NoScaleOffset]_TextureSample3("顶点偏移", 2D) = "white" {}
		_Float5("X轴偏移", Float) = 0
		_Float6("Y轴偏移", Float) = 0
		_Vector0("偏移方向", Vector) = (0.48,0,0,0)
		_Float4("偏移强度", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord35 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult42 = (float2(_Float5 , _Float6));
				...
				float3 vertexValue = ( tex2Dlod( _TextureSample3, float4( ( texCoord35 + ( appendResult42 * _TimeParameters.x ) ), 0, 0.0) ) * _Float4 * float4( _Vector0 , 0.0 ) ).rgb;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_TextureSample010 = IN.ase_texcoord8.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
				
				float2 uv_TextureSample221 = IN.ase_texcoord8.xy;
				
				float2 uv_TextureSample113 = IN.ase_texcoord8.xy;
				float4 tex2DNode13 = tex2D( _TextureSample1, uv_TextureSample113 );
				

				float3 BaseColor = ( _Color0 * tex2DNode10 ).rgb;
				float3 Normal = ( tex2D( _TextureSample2, uv_TextureSample221 ) * _Float2 ).rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( tex2DNode13.r * _Float0 );
				float Smoothness = ( tex2DNode13.a * _Float1 );
				float Occlusion = 1;
				float Alpha = 1;
				float AlphaClipThreshold = ( _Color0 * tex2DNode10 ).r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_TextureSample010 = IN.ase_texcoord3.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord35 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult42 = (float2(_Float5 , _Float6));
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_TextureSample010 = IN.ase_texcoord4.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_TextureSample010 = IN.ase_texcoord2.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_TextureSample221 = IN.ase_texcoord5.xy;
				
				float2 uv_TextureSample010 = IN.ase_texcoord5.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_TextureSample010 = IN.ase_texcoord.xy;
				float4 tex2DNode10 = tex2D( _TextureSample0, uv_TextureSample010 );
				clip( tex2DNode10.a - _Float3);
				

				surfaceDescription.Alpha = 1;
				surfaceDescription.AlphaClipThreshold = ( _Color0 * tex2DNode10 ).r;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;40;-1038.457,568.0328;Inherit;False;Property;_Float5;X轴偏移;9;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-1038.457,646.0328;Inherit;False;Property;_Float6;Y轴偏移;10;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;42;-822.4573,563.0328;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;43;-916.4573,756.0328;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;35;-996.8096,252.3362;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-656.4573,596.0328;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;26;-1183.749,-1147.725;Inherit;False;911;1054;Comment;23;0;2;3;4;5;6;7;8;9;11;10;13;19;22;23;18;17;21;12;16;25;45;46;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;39;-487.4573,368.0328;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;10;-1080.749,-913.7239;Inherit;True;Property;_TextureSample0;基础色;0;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;9f4ec378e076b494d9364ca6ccba7598;9f4ec378e076b494d9364ca6ccba7598;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-1023.749,-1097.725;Inherit;False;Property;_Color0;颜色;1;0;Create;False;0;0;0;False;0;False;0.5490196,0.5411765,0.5411765,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;28;-104.171,595.3807;Inherit;False;Property;_Vector0;偏移方向;11;0;Create;False;0;0;0;False;0;False;0.48,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;29;-158.171,467.3807;Inherit;False;Property;_Float4;偏移强度;12;0;Create;False;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;27;-159.171,243.3807;Inherit;True;Property;_TextureSample3;顶点偏移;8;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;a3edfaaec04ed464cbf9560bccb59832;a3edfaaec04ed464cbf9560bccb59832;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-620.7482,-1017.724;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-761.1547,-764.7186;Inherit;False;Property;_Float3;剪切;2;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-1133.749,-718.7239;Inherit;True;Property;_TextureSample1;遮罩;3;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;19;-933.7487,-503.7241;Inherit;False;Property;_Float1;粗糙;5;0;Create;False;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-729.7487,-312.724;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1093.749,-206.7245;Inherit;False;Property;_Float2;发现强度;7;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-856.7487,-646.7238;Inherit;False;Property;_Float0;金属;4;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-656.7485,-561.7239;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-583.748,-670.7238;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;232.829,361.3807;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;21;-1095.749,-401.724;Inherit;True;Property;_TextureSample2;法线;6;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClipNode;45;-449.1385,-927.6056;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-402.711,-756.3214;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;639,-3;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;ASE/DingDianPianYi;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;39;Workflow;1;0;Surface;0;638838223852949724;  Refraction Model;0;0;  Blend;2;638838223624930053;Two Sided;0;638838212997853426;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-985.7487,-860.7239;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
