...
Shader "ASE/XiaoRong"
{
	Properties
	{
		...
		[NoScaleOffset]_TextureSample0("颜色", 2D) = "white" {}
		_Color0("乘颜色", Color) = (1,1,1,0)
		[NoScaleOffset]_TextureSample1("金属粗糙", 2D) = "white" {}
		_Float0("乘金属", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_12_0 = ( tex2D( _TextureSample0, uv_TextureSample010 ) * _Color0 );
				
				float2 uv_TextureSample220 = IN.ase_texcoord8.xy;
				float3 unpack20 = UnpackNormalScale( tex2D( _TextureSample2, uv_TextureSample220 ), _Float2 );
				unpack20.z = lerp( 1, unpack20.z, saturate(_Float2) );
				
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord8.xy;
				...
				float3 appendResult19 = (float3(tex2DNode13.r , tex2DNode13.g , tex2DNode13.b));
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord3.xy;
				float4 tex2DNode22 = tex2D( _TextureSample3, uv_TextureSample322 );
				float temp_output_27_0 = step( temp_output_32_0 , ( tex2DNode22.r + _Float4 ) );
				#if defined(_KEYWORD1_X)
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord4.xy;
				float4 tex2DNode22 = tex2D( _TextureSample3, uv_TextureSample322 );
				float temp_output_27_0 = step( temp_output_32_0 , ( tex2DNode22.r + _Float4 ) );
				float temp_output_28_0 = ( temp_output_27_0 - step( temp_output_32_0 , tex2DNode22.r ) );
				float4 lerpResult31 = lerp( temp_output_12_0 , ( temp_output_28_0 * _Color1 ) , temp_output_28_0);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord2.xy;
				float4 tex2DNode22 = tex2D( _TextureSample3, uv_TextureSample322 );
				float temp_output_27_0 = step( temp_output_32_0 , ( tex2DNode22.r + _Float4 ) );
				#if defined(_KEYWORD1_X)
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_TextureSample220 = IN.ase_texcoord5.xy;
				float3 unpack20 = UnpackNormalScale( tex2D( _TextureSample2, uv_TextureSample220 ), _Float2 );
				unpack20.z = lerp( 1, unpack20.z, saturate(_Float2) );
				
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord5.xy;
				float4 tex2DNode22 = tex2D( _TextureSample3, uv_TextureSample322 );
				float temp_output_27_0 = step( temp_output_32_0 , ( tex2DNode22.r + _Float4 ) );
				#if defined(_KEYWORD1_X)
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float temp_output_32_0 = (0.0 + (_Float3 - 0.0) * (1.2 - 0.0) / (1.0 - 0.0));
				float2 uv_TextureSample322 = IN.ase_texcoord.xy;
				float4 tex2DNode22 = tex2D( _TextureSample3, uv_TextureSample322 );
				float temp_output_27_0 = step( temp_output_32_0 , ( tex2DNode22.r + _Float4 ) );
				#if defined(_KEYWORD1_X)
...
Node;AmplifyShaderEditor.StaticSwitch;133;-1520.906,1239.739;Inherit;False;Property;_Keyword6;XY方向翻转;18;0;Create;False;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-1317.96,107.3722;Inherit;False;Property;_Float0;乘金属;3;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-1340.96,-76.62779;Inherit;True;Property;_TextureSample1;金属粗糙;2;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-1340.96,-443.6277;Inherit;True;Property;_TextureSample0;颜色;0;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;20;-1322.96,265.3723;Inherit;True;Property;_TextureSample2;法线;5;2;[NoScaleOffset];[Normal];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;21;-1625.959,315.3723;Inherit;False;Property;_Float2;法线强度;6;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FEB47C4176A4A97F53C10A99EE6ECF3BAE9897CF