...
Shader "ASE/Terrain"
{
	Properties
	{
		...
		_Color1("土地1叠加颜色", Color) = (1,1,1,0)
		[NoScaleOffset]_TextureSample0("土地1", 2D) = "white" {}
		[NoScaleOffset]_TextureSample1("土地1法线", 2D) = "bump" {}
		_Float1("土地1比例", Range( 1 , 500)) = 1
		[NoScaleOffset]_TextureSample5("土地1遮罩", 2D) = "white" {}
		_Float0("土地1法线强度", Range( 0 , 1)) = 1
		_Color0("土地2叠加颜色", Color) = (1,1,1,0)
		[NoScaleOffset]_TextureSample2("土地2", 2D) = "white" {}
		[NoScaleOffset]_TextureSample3("土地法线2", 2D) = "bump" {}
		[NoScaleOffset]_TextureSample6("土地遮罩2", 2D) = "white" {}
		_Float2("土地2比例", Range( 1 , 500)) = 1
		_Float3("土地2法线强度", Range( 0 , 1)) = 1
		_Float4("土地1_2混合比例", Range( 1 , 100)) = 1
		_Float12("土地1_2混合强度", Range( 0.1 , 1)) = 0.7652174
		_Float5("粗糙", Range( 0 , 1)) = 0
		_Float6("金属强度", Range( 0 , 1)) = 0
		_Float7("草地比例", Range( 1 , 500)) = 1
		[NoScaleOffset]_TextureSample7("草地颜色", 2D) = "black" {}
		_Color2("草地叠加颜色", Color) = (1,1,1,0)
		[NoScaleOffset]_TextureSample9("草地遮罩", 2D) = "black" {}
		_Float10("草地金属", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode46 = tex2D( _TextureSample5, texCoord11 );
				float4 tex2DNode54 = tex2D( _TextureSample6, texCoord22 );
				float4 tex2DNode68 = tex2D( _TextureSample9, texCoord61 );
				...
				float3 Normal = ( ( ( ( unpack14 * smoothstepResult87 ) + ( unpack21 * temp_output_36_0 ) ) * temp_output_121_0 ) + ( unpack69 * smoothstepResult83 ) );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( ( ( ( tex2DNode46.g * _Float6 * smoothstepResult87 ) + ( tex2DNode54.g * _Float6 * temp_output_36_0 ) ) * temp_output_121_0 ) + ( tex2DNode68.g * _Float10 * smoothstepResult83 ) );
				float Smoothness = ( ( ( ( tex2DNode46.a * _Float5 * smoothstepResult87 ) + ( tex2DNode54.a * _Float5 * temp_output_36_0 ) ) * temp_output_121_0 ) + ( tex2DNode68.a * _Float11 * smoothstepResult83 ) );
				float Occlusion = 1;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1436.509,955.8689;Inherit;False;Property;_Float6;金属强度;15;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1430.6,1045.721;Inherit;False;Property;_Float5;粗糙;14;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-1748.965,1378.083;Inherit;False;Property;_Float12;土地1_2混合强度;13;0;Create;False;0;0;0;False;0;False;0.7652174;0;0.1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-1518.437,2028.164;Inherit;False;Property;_Float7;草地比例;16;0;Create;False;0;0;0;False;0;False;1;0;1;500;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-1241.37,2473.428;Inherit;False;Property;_Float9;草地法线强度;23;0;Create;False;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-875.3077,2593.373;Inherit;False;Property;_Float10;草地金属;20;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-871.8742,2694.538;Inherit;False;Property;_Float11;草地粗糙;21;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;59;-876.8384,1988.877;Inherit;True;Property;_TextureSample7;草地颜色;17;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;69;-876.5679,2408.514;Inherit;True;Property;_TextureSample10;草地法线;22;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;68;-875.2675,2210.685;Inherit;True;Property;_TextureSample9;草地遮罩;19;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;-2228.077,467.2563;Inherit;False;Property;_Float2;土地2比例;10;0;Create;False;0;0;0;False;0;False;1;0;1;500;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;93;-1414.192,139.8876;Inherit;False;Property;_Color0;土地2叠加颜色;6;0;Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;36;-414.3901,1273.617;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-260.8997,-82.15443;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-174.8315,356.5962;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-220.2993,199.6973;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;39;72.57216,-19.14147;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;51;114.3669,232.4057;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;58;93.99227,653.1414;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-116.1682,512.4799;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-73.43762,829.2868;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-92.33496,690.2682;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-215.2006,40.54118;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;-426.69,313.9005;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-69.55598,-294.9918;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-1492.126,-491.8243;Inherit;True;Property;_TextureSample0;土地1;1;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;95;-876.855,-807.4074;Inherit;False;Property;_Color1;土地1叠加颜色;0;0;Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;96;-277.7352,-524.7087;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;107;-797.5741,1772.081;Inherit;False;Property;_Color2;草地叠加颜色;18;0;Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;-280.7491,1993.906;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;113;-1712.709,946.5754;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;7.7;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;14;-1462.884,-284.3482;Inherit;True;Property;_TextureSample1;土地1法线;2;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-870.0831,3022.248;Inherit;False;Property;_Float13;草地分布平滑;24;0;Create;False;0;0;0;False;0;False;1;0;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;122;-1458.467,3206.018;Inherit;False;Property;_Float14;草地分布;25;0;Create;False;0;0;0;False;0;False;5;0;1;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-2278.936,1209.695;Inherit;False;Property;_Float4;土地1_2混合比例;12;0;Create;False;0;0;0;False;0;False;1;0;1;100;0;1;FLOAT;0
...
WireConnection;57;0;46;4
WireConnection;57;1;33;0
WireConnection;57;2;87;0
...
ASEEND*/
//CHKSM=49C3D06CC0788751DA23CEE7EEBED4CF85FDD9A2